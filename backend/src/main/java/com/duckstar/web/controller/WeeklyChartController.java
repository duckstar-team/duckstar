...
public class WeeklyChartController {
    ...
    @Operation(summary = "주차별 애니메이션 차트 조회 API (with Anime Trend)",
            description = "path variable 해당 주차 애니, Anime Trend")
    ...
    @Operation(summary = "AniLab 차트 조회 API",
            description = "프론트 탭 전환용: path variable 해당 주차 AniLab")
    ...
    @Operation(summary = "주차별 남캐 차트 조회 API (with Anime Trend)",
            description = "path variable 해당 주차 남캐, Anime Trend")
    ...
    @Operation(summary = "주차별 여캐 차트 조회 API (with Anime Trend)",
            description = "path variable 해당 주차 여캐, Anime Trend")
