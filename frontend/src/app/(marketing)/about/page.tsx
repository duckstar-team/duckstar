...
export default function AboutPage() {
  const mainFeatures = [
    ...
    '투표 결과: 주간 마지막 후보 투표가 마감되면 검증 후 공개',
          ...
          <div className="space-y-6 text-gray-700">
            <Section title="서비스 소개">
              <p className="leading-relaxed">
                ...
                애니메이션 팬들이 함께 소통하고 인기 작품을 선정할 수 있는
                공간을 제공합니다.
              </p>
            </Section>
            ...
            <Section title="베타 서비스">
              <p className="leading-relaxed">
                현재 덕스타는 베타 버전으로 운영되고 있습니다. 모든 핵심 기능이
                구현되어 있으며, 사용자 피드백을 바탕으로 지속적으로 개선하고
                있습니다.
              </p>
            </Section>
            ...
            <Section title="문의 및 피드백">
              <p className="leading-relaxed">
                문의 및 피드백은 이메일(bright_aid@naver.com)로 보내주세요.{' '}
                <br />
                서비스 이용 중 궁금한 점이나 개선사항이 있으시면 언제든 연락해
                주세요. 여러분의 소중한 의견이 덕스타를 더 좋은 서비스로
                만들어갑니다.
              </p>
            </Section>
