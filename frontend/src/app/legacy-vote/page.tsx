...
import VoteResultCardLoggedIn from "@/components/legacy-vote/VoteResultCardLoggedIn";
import VoteBanner from "@/components/legacy-vote/VoteBanner";
import VoteSection from "@/components/legacy-vote/VoteSection";
import VoteStamp from "@/components/legacy-vote/VoteStamp";
import VoteCard from "@/components/legacy-vote/VoteCard";
import ConfettiEffect from "@/components/legacy-vote/ConfettiEffect";
import ConfirmDialog from "@/components/legacy-vote/ConfirmDialog";
import VoteDisabledState from "@/components/legacy-vote/VoteDisabledState";
