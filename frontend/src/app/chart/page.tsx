        ...
        <div className="sticky top-[60px] z-40 flex justify-center mb-8">
         ...
         <div className="flex flex-col xl:flex-row gap-[70px] items-center xl:items-start justify-center mt-[10px] sm:mt-[46px] pb-12">
          ...
          {winnerAnime ? (
            ...
            distribution={createDistributionArray(winnerAnime.voteResultDto, selectedWeek ? `${selectedWeek.year}년 ${selectedWeek.quarter}분기 ${selectedWeek.week}주차` : "25년 4분기 1주차")}
          ...
          {allAnimeList.slice(1).map((anime, index) => {
            ...
            return (
              <RankCard
                ...
                distribution={createDistributionArray(anime.voteResultDto, selectedWeek ? `${selectedWeek.year}년 ${selectedWeek.quarter}분기 ${selectedWeek.week}주차` : "25년 4분기 1주차")}
          ...
          {!hasNextPage && allAnimeList.length > 1 && (
           ...
           {/* 해외 랭킹 리스트 */}
           <div className={`${isDesktop ? 'hidden lg:flex' : activeView !== 'duckstar' ? 'flex' : 'hidden'} flex-col gap-5 items-center`}>
            {(() => {
