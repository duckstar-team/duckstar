    ...
    <div className="bg-gray-50">
      <div className="w-full">
        ...
        <div className="mb-4 flex justify-center">
          <div className="relative h-[99px] w-full overflow-hidden">
            ...
            <div className="absolute inset-0 inline-flex flex-col items-center justify-center gap-1 sm:gap-0">
              <div
                className="justify-center font-['Pretendard'] text-xl leading-tight font-bold whitespace-nowrap text-white sm:text-2xl sm:leading-[1.2] md:text-3xl md:leading-[1.3] lg:text-4xl lg:leading-[50.75px]"
                style={{ textShadow: '0 0 2px rgba(0,0,0,0.8)' }}
              >
                {year} {quarterName} {week}주차 애니메이션 순위
              </div>
              <div className="-mt-[5px] h-6 justify-center self-stretch text-center font-['Pretendard'] text-base font-light tracking-wide text-white">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="flex w-[768px] items-center justify-start pl-2">
                <div className="relative h-12 w-44 overflow-hidden">
                  ...
                  >
                    <p
                      className={`text-md text-center font-['Pretendard'] leading-tight text-nowrap whitespace-pre not-italic md:text-[20px] md:leading-[22px] ${
                ...
                <div className="inline-flex h-12 items-center justify-start pl-2">
                  ...
                  <div className="hidden min-[500px]:flex">
                    ...
                    <div className="relative h-12 w-44">
                      ...
                      >
                        <div
                          className={`text-md justify-start self-stretch font-['Pretendard'] leading-tight md:text-xl md:leading-snug ${
                    ...
                    <div className="relative h-12 w-44">
                      ...
                      >
                        <div
                          className={`text-md justify-start self-stretch text-center font-['Pretendard'] leading-tight md:text-xl md:leading-snug ${
        ...
        <div className="mt-[10px] flex flex-col items-center justify-center gap-[70px] pb-12 sm:mt-[46px] xl:flex-row xl:items-start">
          ...
          >
            ...
            {winnerAnime ? (
              <Winner
                ...
                image={winnerAnime.rankPreviewDto.mainThumbnailUrl}
                rating={
                  Math.round((winnerAnime.starInfoDto?.starAverage ?? 0) * 10) /
                  10
                }
                ...
                averageRating={winnerAnime.starInfoDto?.starAverage ?? 0}
                participantCount={winnerAnime.starInfoDto?.userStarScore ?? 0} // TODO: 투표자 수 추가 필요
                distribution={createDistributionArray(
                  winnerAnime.starInfoDto,
                  `${year}년 ${quarter}분기 ${week}주차`
                )}
              ...
              /* 덕스타 차트가 없을 때 스켈레톤 */
              <div className="flex h-[200px] w-full max-w-[768px] items-center justify-center rounded-lg bg-gray-200">
            ...
            {allAnimeList.slice(1).map((anime, index) => {
              ...
              return (
                <RankCard
                  ...
                  image={anime.rankPreviewDto.mainThumbnailUrl}
                  rating={
                    Math.round((anime.starInfoDto?.starAverage ?? 0) * 10) / 10
                  }
                  ...
                  week={`${year}년 ${quarter}분기 ${week}주차`}
                  averageRating={anime.starInfoDto?.starAverage ?? 0}
                  participantCount={anime.starInfoDto?.userStarScore ?? 0} // TODO: 투표자 수 추가 필요
                  distribution={createDistributionArray(
                    anime.starInfoDto,
                    `${year}년 ${quarter}분기 ${week}주차`
                  )}
          ...
          {/* 해외 랭킹 리스트 */}
          <div
            className={`${isDesktop ? 'flex' : activeView !== 'duckstar' ? 'flex' : 'hidden'} w-full max-w-[370px] flex-col items-center gap-5 px-4`}
          >
            {(() => {
              ...
              if (abroadData.length === 0) {
                return (
                  <div className="relative h-[220px] w-full max-w-[370px]">
                    {/* 스켈레톤 UI (뒷배경) */}
