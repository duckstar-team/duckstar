...
export default function HeaderList({ weekDtos, selectedWeek: propSelectedWeek, onWeekChange, className = "" }: HeaderListProps) {
  ...
  return (
    <div className={`w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:w-[750px] pl-3 sm:px-4 md:px-5 inline-flex justify-between md:justify-between lg:justify-start lg:gap-100 xl:justify-between items-end gap-18 sm:gap-70 md:gap-90 xl:gap-90 ${className}`}>
