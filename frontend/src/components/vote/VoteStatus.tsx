...
export default function VoteStatus({
    ...
    if (hasReachedMaxVotes && !hasClickedBonus && !showGenderSelection) {
      const updatePosition = () => {
        ...
        const defaultButton = document.querySelector(
          '[data-bonus-button]:not([data-vote-section-sticky] [data-bonus-button])'
        );
  ...
  useEffect(() => {
    if (isBonusMode && !showGenderSelection) {
      const updateStampPosition = () => {
        ...
        const stickyStamp = document.querySelector(
          '[data-vote-section-sticky] [data-bonus-stamp]'
        );
        const defaultStamp = document.querySelector(
          '[data-bonus-stamp]:not([data-vote-section-sticky] [data-bonus-stamp])'
        );
  ...
  return (
    <div className="flex min-h-16 w-full flex-wrap items-center justify-center overflow-visible">
      ...
      <div
        className={`flex min-h-16 flex-wrap items-center justify-center overflow-visible ${
          showGenderSelection
