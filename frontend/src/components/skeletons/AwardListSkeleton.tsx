    ...
    <main className={`max-width ${className}`}>
      <div className="flex flex-col gap-10 @lg:flex-row @lg:items-start @lg:gap-8">
        ...
        <div className="flex-1">
          <div className="mb-5 h-8 w-48 animate-pulse rounded bg-gray-200" />
            ...
            {Array.from({ length: cardCount }).map((_, index) => (
              ...
              >
                ...
                <div className="relative w-full">
                  <div className="h-32 w-full animate-pulse bg-gray-200 @lg:h-48" />
                ...
                <div className="flex w-full flex-col justify-between gap-4 p-3 @md:p-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2 @sm:flex-row @sm:items-center @md:gap-3">
                      ...
                      <div className="h-6 w-40 animate-pulse rounded bg-gray-200 @sm:h-7 @md:h-8" />
                    </div>
                    {/* 날짜 */}
                    <div className="h-4 w-48 animate-pulse rounded bg-gray-200 @max-sm:h-3" />
                  </div>

                  {/* 버튼 */}
                  <div className="mt-2 h-10 w-full animate-pulse rounded-full bg-gray-200" />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="w-full @lg:w-[373px]">
          ...
          <div className="flex w-full flex-col gap-4">
            {Array.from({ length: 2 }).map((_, index) => (
              <div
                key={index}
                className="flex h-20 rounded-lg bg-white shadow-lg shadow-gray-200/80"
              >
