  ...
  return (
    <>
      ...
      <div className={`absolute right-[25px] sm:right-3 md:right-[25px] top-0 h-[60px] flex items-center z-10 ${
        ...
        {/* Login/Logout Button */}
        <div className={`flex items-center ${isSearchOpen ? 'md:block hidden' : ''}`}>
          <LoginButton 
            variant="default" 
              ...
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <button 
                  ...
                  style={{
                    padding: '12px 16px',
                    borderRadius: '8px',
                    background: (pathname === '/chart' || pathname.startsWith('/chart/')) ? 'linear-gradient(to right, #cb285e, #9c1f49)' : 'transparent',
                    color: (pathname === '/chart' || pathname.startsWith('/chart/')) ? '#ffffff' : '#586672',
                    fontSize: '16px',
                    fontWeight: (pathname === '/chart' || pathname.startsWith('/chart/')) ? 'bold' : '500',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease-in-out',
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                  <img 
                    src={(pathname === '/chart' || pathname.startsWith('/chart/')) ? "/icons/chart-active.svg" : "/icons/chart-default.svg"}
                    alt="주간 차트"
                    style={{ width: '20px', height: '20px' }}
                  />
                  <span style={{ 
